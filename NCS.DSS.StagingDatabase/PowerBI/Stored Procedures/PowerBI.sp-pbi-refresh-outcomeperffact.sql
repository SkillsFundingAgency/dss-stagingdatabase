CREATE PROCEDURE [PowerBI].[sp-pbi-refresh-outcomeperffact](@pr1 int)
AS
BEGIN
    ...
    CREATE TABLE #tmpTable2 (
        ...
        ,[Group ID] INT
        ,[Date] DATE
        ,[Profile total] DECIMAL(9,2)
        ,[Profile YTD] DECIMAL(9,2)
    ...
    SELECT 
        ...
        TRUNCATE TABLE [PowerBI].[dss-pbi-outcomeperffact];

        INSERT INTO [PowerBI].[dss-pbi-outcomeperffact]
        SELECT 
            AF.[TouchpointID]
            ,AF.[Outcome ID]
            ,AF.[Group ID]
